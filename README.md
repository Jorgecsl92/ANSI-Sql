...
- Consultas SQL estándar (ANSI SQL)
- Ejercicios prácticos aplicados a entornos reales
- Prácticas progresivas por días del curso
...
- Joins, subconsultas, agrupaciones  
- Funciones de agregación  
- Operadores lógicos y relacionales  
- Ejercicios organizados por sesiones de trabajo
...
- Desarrollar un repositorio organizado como herramienta profesional.
